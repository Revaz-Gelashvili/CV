  ...
  return (
    <div className="hero flex justify-center" id="hero">
      <div className="content w-lg md:w-screen md:px-20 lg:px-48  h-auto flex flex-col gap-30 md:flex-row lg:justify-between items-center mt-20">
        <div className="left-div h-[500px] md:h-[600px] w-full text-center md:text-left text-white flex flex-col justify-between items-center md:items-baseline">
          ...
          >
            <button className="w-sm sm:m-0 md:w-96 h-24 font-bold text-3xl md:text-4xl text-black rounded-2xl">
              {t("hero.button")}
            </button>
          </a>
        </div>
